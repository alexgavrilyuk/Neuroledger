 ...
 * PHASE 3 UPDATE: Added examples to generate_analysis_code description.
 */
...
const toolDefinitions = [
    ...
    },
    {
        ...
        args: {
            // 'code' arg removed from definition as system substitutes it. LLM only needs to provide dataset_id.
            // code: 'string', // (Optional, usually substituted) The generated Node.js code to execute.
    ...
    // Final Output Tool
    {
        ...
        output: 'Signals the end of the agent\'s turn. Does not return a structured object, only indicates success/failure via status.' // Updated output desc
    }
];
